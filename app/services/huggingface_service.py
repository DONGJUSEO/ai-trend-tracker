...
class HuggingFaceService:
    ...
    PIPELINE_TAG_KO = {
        ...
        "text2text-generation": "텍스트-투-텍스트",
        "depth-estimation": "깊이 추정",
        "video-classification": "비디오 분류",
        "reinforcement-learning": "강화학습",
        "unconditional-image-generation": "비조건부 이미지 생성",
        "zero-shot-classification": "제로샷 분류",
        "document-question-answering": "문서 질의 응답",
        "visual-question-answering": "시각 질의 응답",
        "table-question-answering": "표 질의 응답",
        "text-to-3d": "3D 생성",
        "image-to-3d": "이미지-3D 변환",
        "text-to-audio": "텍스트-오디오 변환",
